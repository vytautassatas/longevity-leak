export const layout = {
  rails: {
    wide: "mx-auto w-full max-w-[1040px] px-5 pb-28 pt-12 sm:px-6 sm:pt-16 lg:px-8",
    detail: "mx-auto w-full max-w-[900px] px-5 pb-28 pt-12 sm:px-6 sm:pt-16 lg:px-8",
    article: "mx-auto w-full max-w-[720px] px-5 pb-28 pt-12 sm:px-6 sm:pt-16 lg:px-8"
  },
  chromeRail: "mx-auto w-full max-w-[1040px] px-5 sm:px-6 lg:px-8",
  hero: {
